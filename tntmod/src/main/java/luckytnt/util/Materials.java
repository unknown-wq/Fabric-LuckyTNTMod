...
public class Materials {
	...
	//WOOD
	static final Set<Block> WOOD = Set.of(Blocks.BAMBOO_MOSAIC, Blocks.BAMBOO_MOSAIC_SLAB, Blocks.BAMBOO_MOSAIC_STAIRS, Blocks.BOOKSHELF, Blocks.CHISELED_BOOKSHELF, Blocks.CRAFTING_TABLE, Blocks.MUSHROOM_STEM, Blocks.BROWN_MUSHROOM_BLOCK, Blocks.RED_MUSHROOM_BLOCK, Blocks.CHEST, Blocks.TRAPPED_CHEST, Blocks.NOTE_BLOCK, Blocks.JUKEBOX, Blocks.SMITHING_TABLE, Blocks.LECTERN, Blocks.FLETCHING_TABLE, Blocks.COMPOSTER, Blocks.BARREL, Blocks.LOOM, Blocks.CARTOGRAPHY_TABLE);
	static final List<TagKey<Block>> WOOD_TAGS = List.of(BlockTags.LOGS, BlockTags.PLANKS, BlockTags.ALL_SIGNS, BlockTags.WOODEN_TRAPDOORS, BlockTags.WOODEN_DOORS, BlockTags.WOODEN_SLABS, BlockTags.WOODEN_STAIRS, BlockTags.WOODEN_BUTTONS, BlockTags.WOODEN_PRESSURE_PLATES, BlockTags.WOODEN_FENCES, BlockTags.FENCE_GATES, BlockTags.BAMBOO_BLOCKS, BlockTags.CAMPFIRES, BlockTags.BEEHIVES, BlockTags.BANNERS);
	
	//PLANTS
	static final Set<Block> EXCLUDED_PLANTS = Set.of(Blocks.PUMPKIN, Blocks.CARVED_PUMPKIN, Blocks.JACK_O_LANTERN, Blocks.MELON);
	static final Set<Block> INCLUDED_PLANTS = Set.of(Blocks.CACTUS, Blocks.BAMBOO, Blocks.BAMBOO_SAPLING);
	
	//WATER_PLANTS
	static final Set<Block> WATER_PLANTS = Set.of(Blocks.SEA_PICKLE, Blocks.KELP, Blocks.KELP_PLANT, Blocks.SEAGRASS, Blocks.TALL_SEAGRASS);
	
	//STONE
	static final List<TagKey<Block>> STONE_TAGS = List.of(BlockTags.BASE_STONE_OVERWORLD, BlockTags.BASE_STONE_NETHER, ConventionalBlockTags.ORES, ConventionalBlockTags.STONES, ConventionalBlockTags.COBBLESTONES, ConventionalBlockTags.QUARTZ_ORES, BlockTags.STONE_BRICKS, BlockTags.STONE_BUTTONS, BlockTags.STONE_PRESSURE_PLATES, ConventionalBlockTags.SANDSTONE_BLOCKS, ConventionalBlockTags.SANDSTONE_SLABS, ConventionalBlockTags.SANDSTONE_STAIRS, BlockTags.WALLS, BlockTags.TERRACOTTA);
	static final Set<Block> STONE = Set.of(Blocks.PRISMARINE, Blocks.PRISMARINE_BRICK_SLAB, Blocks.PRISMARINE_BRICK_STAIRS, Blocks.PRISMARINE_BRICKS, Blocks.PRISMARINE_SLAB, Blocks.PRISMARINE_STAIRS, Blocks.DARK_PRISMARINE, Blocks.DARK_PRISMARINE_SLAB, Blocks.DARK_PRISMARINE_STAIRS,
	...
	public static boolean isWood(BlockState state) {
		//O(1) set lookup first, the tag loop is the expensive part
		if(WOOD.contains(state.getBlock())) {
			return true;
		}
	...
	public static boolean isPlant(BlockState state) {
		...
		if(INCLUDED_PLANTS.contains(block)) {
			return true;
		}
		return state.is(BlockTags.SWORD_EFFICIENT) && !EXCLUDED_PLANTS.contains(block);
	}
