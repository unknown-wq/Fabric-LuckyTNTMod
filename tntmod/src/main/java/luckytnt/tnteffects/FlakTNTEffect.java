...
public class FlakTNTEffect extends PrimedTNTEffect {
	...
	public void explosionTick(IExplosiveEntity entity) {
		...
		if(!level.isClient && entity.getTNTFuse() <= 600) {
			List<PlayerEntity> players = level.getNonSpectatingEntities(PlayerEntity.class, new Box(entity.getPos().add(-150, -150, -150), entity.getPos().add(150, 150, 150)));
