...
public class SayGoodbyeEffect extends PrimedTNTEffect{
	...
	public void serverExplosion(IExplosiveEntity entity) {		
		...
		if(ent != null) {
			Reference<DamageType> type = entity.getLevel().getRegistryManager().get(Registries.DAMAGE_TYPE).entryOf(RegistryKey.of(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(LuckyTNTMod.MODID, "say_goodbye")));
