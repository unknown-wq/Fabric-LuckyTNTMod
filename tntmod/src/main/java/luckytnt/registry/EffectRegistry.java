...
public class EffectRegistry {
	...
	public static final ResourceKey<MobEffect> CONTAMINATED = ResourceKey.create(Registries.MOB_EFFECT, Identifier.fromNamespaceAndPath(LuckyTNTMod.MODID, "contaminated"));
	public static final ResourceKey<MobEffect> MIDAS_TOUCH = ResourceKey.create(Registries.MOB_EFFECT, Identifier.fromNamespaceAndPath(LuckyTNTMod.MODID, "midas_touch"));
	...
	public static Supplier<MobEffect> registerEffect(Supplier<MobEffect> effect, String name) {
		MobEffect reffect = Registry.register(BuiltInRegistries.MOB_EFFECT, Identifier.fromNamespaceAndPath(LuckyTNTMod.MODID, name), effect.get());
		return () -> reffect;
	}
